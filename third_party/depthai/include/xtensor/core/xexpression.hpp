...
struct is_crtp_base_of_impl<B, F<E>>
    : std::disjunction<std::is_base_of<B<E>, F<E>>,
...
struct xoptional_comparable
    : std::conjunction<std::disjunction<is_xtensor_expression<E>,
 ...
 public:
  ...
  using inner_backstrides_type =
      xtl::mpl::eval_if_t<has_strides<E>,
                          ...
                          get_strides_type<shape_type>>;
  using storage_type =
      xtl::mpl::eval_if_t<has_storage_type<E>, detail::expr_storage_type<E>,
                          make_invalid_type<>>;
