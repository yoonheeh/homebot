...
struct linear_iterator_traits_impl<D, true> {
  ...
  using iterator_type =
      get_storage_iterator<storage_type, std::is_const<storage_type>::value>;
  ...
  using const_reverse_linear_iterator =
      typename iterator_type::const_reverse_iterator;
};
...
template <class D>
using linear_iterator_traits =
    linear_iterator_traits_impl<D, has_storage_type<D>::value>;
}  // namespace detail
...
class xcontiguous_iterable : private xiterable<D> {
 public:
  ...
  using select_iterator =
      select_iterator_impl<L, linear_iterator, layout_iterator<L>>;
  template <layout_type L>
  using select_const_iterator =
      select_iterator_impl<L, const_linear_iterator, const_layout_iterator<L>>;
  template <layout_type L>
  using select_reverse_iterator =
      select_iterator_impl<L, reverse_linear_iterator,
                           reverse_layout_iterator<L>>;
  template <layout_type L>
  using select_const_reverse_iterator =
      select_iterator_impl<L, const_reverse_linear_iterator,
