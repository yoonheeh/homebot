...
struct has_simd_interface<xfunction<F, CT...>, T>
    : std::conjunction<has_simd_type<T>,
...
struct overlapping_memory_checker_traits<
  ...
  template <std::size_t I = 0, class... T,
            std::enable_if_t<(I < sizeof...(T)), int> = 0>
  static bool check_tuple(const std::tuple<T...> &t,
                          const memory_range &dst_range) {
    using ChildE = std::decay_t<decltype(std::get<I>(t))>;
    return overlapping_memory_checker_traits<ChildE>::check_overlap(
               std::get<I>(t), dst_range) ||
...
class xfunction_iterator : public xtl::xrandom_access_iterator_base<
 ...
 private:
  using data_type = std::tuple<decltype(xt::linear_begin(
...
template <class F, class... CT>
inline auto xfunction<F, CT...>::linear_begin() const noexcept
    -> const_linear_iterator {
  return linear_cbegin();
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::linear_end() const noexcept
    -> const_linear_iterator {
  return linear_cend();
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::linear_cbegin() const noexcept
    -> const_linear_iterator {
...
template <class F, class... CT>
inline auto xfunction<F, CT...>::linear_cend() const noexcept
    -> const_linear_iterator {
...
template <class F, class... CT>
inline auto xfunction<F, CT...>::linear_rbegin() const noexcept
    -> const_reverse_linear_iterator {
  return linear_crbegin();
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::linear_rend() const noexcept
    -> const_reverse_linear_iterator {
  return linear_crend();
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::linear_crbegin() const noexcept
    -> const_reverse_linear_iterator {
  return const_reverse_linear_iterator(linear_cend());
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::linear_crend() const noexcept
    -> const_reverse_linear_iterator {
