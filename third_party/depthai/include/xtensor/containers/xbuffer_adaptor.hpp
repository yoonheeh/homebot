...
class xbuffer_owner_storage {
 public:
  ...
  template <class P>
  void reset_data(P &&data, size_type size,
...
template <class CP, class A>
template <class P>
inline void xbuffer_storage<CP, A>::reset_data(P &&data,
...
template <class CP, class A>
template <class P>
inline void xbuffer_owner_storage<CP, A>::reset_data(
    P &&data, size_type size, const allocator_type &alloc) noexcept {
...
template <class CP, class D>
template <class P, class DT>
void xbuffer_smart_pointer<CP, D>::reset_data(P &&data, size_type size,
                                              DT &&destruct) noexcept {
  p_data = std::forward<P>(data);
  m_size = size;
  m_destruct = destruct;
}
