...
struct all_xscalar {
  static constexpr bool value =
      std::conjunction<is_xscalar<std::decay_t<E>>...>::value;
};
}  // namespace detail
...
template <class CT>
inline auto xscalar<CT>::linear_rbegin() const noexcept
    -> const_reverse_iterator {
  return this->template rbegin<XTENSOR_DEFAULT_LAYOUT>();
}

template <class CT>
inline auto xscalar<CT>::linear_rend() const noexcept
    -> const_reverse_iterator {
  return this->template rend<XTENSOR_DEFAULT_LAYOUT>();
}

template <class CT>
inline auto xscalar<CT>::linear_crbegin() const noexcept
    -> const_reverse_iterator {
  return this->template crbegin<XTENSOR_DEFAULT_LAYOUT>();
}

template <class CT>
inline auto xscalar<CT>::linear_crend() const noexcept
    -> const_reverse_iterator {
...
template <bool is_const, class CT>
inline auto xdummy_iterator<is_const, CT>::operator++() noexcept
    -> self_type & {
  return *this;
}
