...
struct xcontainer_inner_types<xstrided_view<CT, S, L, FST>> {
  ...
  using temporary_type = typename detail::xtype_for_shape<S>::template type<
      typename xexpression_type::value_type, xexpression_type::static_layout>;
...
class xstrided_view
 ...
 public:
  ...
  using const_reverse_linear_iterator =
      std::reverse_iterator<const_linear_iterator>;
...
template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_begin() const
    -> const_linear_iterator {
  return this->linear_cbegin();
}

template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_end() const
    -> const_linear_iterator {
  return this->linear_cend();
}

template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_cbegin() const
    -> const_linear_iterator {
  return this->storage().cbegin() + static_cast<std::ptrdiff_t>(data_offset());
}

template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_cend() const
    -> const_linear_iterator {
...
template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_rbegin()
    -> reverse_linear_iterator {
  return reverse_linear_iterator(this->linear_begin());
}

template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_rend()
    -> reverse_linear_iterator {
  return reverse_linear_iterator(this->linear_end());
}

template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_rbegin() const
    -> const_reverse_linear_iterator {
  return this->linear_crbegin();
}

template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_rend() const
    -> const_reverse_linear_iterator {
  return this->linear_crend();
}

template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_crbegin() const
    -> const_reverse_linear_iterator {
  return const_reverse_linear_iterator(this->linear_cbegin());
}

template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view<CT, S, L, FST>::linear_crend() const
    -> const_reverse_linear_iterator {
...
template <class S, std::enable_if_t<std::is_signed<get_value_type_t<
...
inline void recalculate_shape_impl(S &shape, size_t size) {
  ...
  if (iter != std::end(shape)) {
    const auto total = std::accumulate(shape.cbegin(), shape.cend(), -1,
                                       std::multiplies<int>{});
...
inline auto reshape_view(E &&e, S &&shape) {
  ...
  using view_type =
      xstrided_view<xclosure_t<E>, unsigned_shape_type, computed_layout,
