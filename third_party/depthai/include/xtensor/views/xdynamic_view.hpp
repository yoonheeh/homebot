...
struct xiterable_inner_types<xdynamic_view<CT, S, L, FST>> {
  ...
  static constexpr auto random_instantiation_var_for_gcc8_data_iface =
      has_data_interface<xdynamic_view<CT, S, L, FST>>::value;
  static constexpr auto random_instantiation_var_for_gcc8_has_strides =
...
class xdynamic_view : public xview_semantic<xdynamic_view<CT, S, L, FST>>,
 ...
 public:
  ...
  using slice_type =
      std::variant<detail::xfake_slice<strides_vt>, xkeep_slice<strides_vt>,
...
inline auto xdynamic_view<CT, S, L, FST>::data_offset() const noexcept
  ...
  size_type sl_offset =
      std::visit([](const auto &sl) { return sl(size_type(0)); }, m_slices[0]);
