...
class xoptional_assembly_linear_iterator
 ...
 public:
  ...
  xoptional_assembly_linear_iterator(value_iterator value_it,
...
inline xoptional_assembly_linear_iterator<
    VE, FE, C>::xoptional_assembly_linear_iterator(value_iterator value_it,
                                                   flag_iterator flag_it)
    : m_value_it(value_it), m_flag_it(flag_it) {}

template <class VE, class FE, bool C>
inline auto xoptional_assembly_linear_iterator<VE, FE, C>::operator++()
    -> self_type & {
  ++m_value_it;
  ++m_flag_it;
  return *this;
...
template <class VE, class FE, bool C>
inline auto xoptional_assembly_linear_iterator<VE, FE, C>::operator*() const
    -> reference {
...
template <class VE, class FE, bool C>
inline bool xoptional_assembly_linear_iterator<VE, FE, C>::operator==(
