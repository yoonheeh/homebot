 ...
 */
template <class D>
inline constexpr auto xoptional_assembly_base<D>::dimension() const noexcept
    -> size_type {
...
template <class D>
inline auto xoptional_assembly_base<D>::linear_begin() noexcept
    -> linear_iterator {
  return linear_iterator(value().linear_begin(), has_value().linear_begin());
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_end() noexcept
    -> linear_iterator {
  return linear_iterator(value().linear_end(), has_value().linear_end());
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_begin() const noexcept
    -> const_linear_iterator {
  return linear_cbegin();
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_end() const noexcept
    -> const_linear_iterator {
  return linear_cend();
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_cbegin() const noexcept
    -> const_linear_iterator {
...
template <class D>
inline auto xoptional_assembly_base<D>::linear_cend() const noexcept
    -> const_linear_iterator {
...
template <class D>
inline auto xoptional_assembly_base<D>::linear_rbegin() noexcept
    -> reverse_linear_iterator {
  return reverse_linear_iterator(linear_end());
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_rend() noexcept
    -> reverse_linear_iterator {
  return reverse_linear_iterator(linear_begin());
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_rbegin() const noexcept
    -> const_reverse_linear_iterator {
  return linear_crbegin();
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_rend() const noexcept
    -> const_reverse_linear_iterator {
  return linear_crend();
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_crbegin() const noexcept
    -> const_reverse_linear_iterator {
  return const_reverse_linear_iterator(linear_cend());
}

template <class D>
inline auto xoptional_assembly_base<D>::linear_crend() const noexcept
    -> const_reverse_linear_iterator {
