...
/**
 * Return an xt::xexpression representing the imaginary part of the given
 * expression.
 *
 * The returned expression either hold a const reference to @p e or a copy
 * depending on whether @p e is an lvalue or an rvalue.
...
/**
 * Return an xt::xfunction evaluating to the complex conjugate of the given
 * expression.
 *
 * @ingroup xt_xcomplex
...
/**
 * Calculates the phase angle (in radians) elementwise for the complex numbers
 * in @p e.
 *
 * @ingroup xt_xcomplex
 * @param e the xt::xexpression
