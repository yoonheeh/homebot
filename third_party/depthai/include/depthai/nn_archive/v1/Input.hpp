 ...
 *
 * @type shape: list
 * @ivar shape: Shape of the input data as a list of integers (e.g. [H,W],
 * [H,W,C], [N,H,W,C], ...).
 *
 * @type layout: str
 * @ivar layout: Lettercode interpretation of the input data dimensions (e.g.,
 * 'NCHW').
 *
...
struct Input {
  ...
  /**
   * Shape of the input data as a list of integers (e.g. [H,W], [H,W,C],
   * [N,H,W,C], ...).
   */
