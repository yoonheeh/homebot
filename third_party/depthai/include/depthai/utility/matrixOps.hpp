...
std::array<std::array<float, 3>, 3> matMul(
...
std::array<std::array<float, 4>, 4> matMul(
    const std::array<std::array<float, 4>, 4> &A,
    const std::array<std::array<float, 4>, 4> &B);

std::vector<float> matVecMul(const std::vector<std::vector<float>> &matrix,
                             const std::vector<float> &vec);
std::array<float, 3> matVecMul(
    const std::array<std::array<float, 3>, 3> &matrix,
    const std::array<float, 3> &vec);

bool mateq(const std::vector<std::vector<float>> &A,
           const std::vector<std::vector<float>> &B,
           float epsilon = MATRIX_EQ_EPSILON);
bool mateq(const std::array<std::array<float, 3>, 3> &A,
           const std::array<std::array<float, 3>, 3> &B,
           float epsilon = MATRIX_EQ_EPSILON);

bool matInv(std::vector<std::vector<float>> &A,
            std::vector<std::vector<float>> &inverse);

std::array<std::array<float, 2>, 2> getMatrixInverse(
    const std::array<std::array<float, 2>, 2> &matrix);
std::array<std::array<float, 3>, 3> getMatrixInverse(
    const std::array<std::array<float, 3>, 3> &matrix);
std::array<std::array<float, 3>, 3> getHomographyMatrix(
...
std::array<std::array<float, 4>, 4> createTransformationMatrix(
    const std::vector<std::vector<float>> &rotation,
    const dai::Point3f &translation);
std::array<std::array<float, 4>, 4> createTransformationMatrix(
    const std::array<std::array<float, 3>, 3> &rotation,
    const dai::Point3f &translation);
dai::Point3f transformPoint3f(const std::array<std::array<float, 4>, 4> &matrix,
                              const dai::Point3f &point);
...
std::vector<float> matrix3x3ToVector(
    const std::array<std::array<float, 3>, 3> &R);
std::vector<float> rotationMatrixToVector(
    const std::vector<std::vector<float>> &R);
std::vector<std::vector<float>> matrix3x3ToVectorMatrix(
    const std::array<std::array<float, 3>, 3> &R);
std::array<std::array<float, 3>, 3> vectorMatrixToMatrix3x3(
    const std::vector<std::vector<float>> &R);

std::array<std::array<float, 3>, 3> getRotationMatrixFromProjection4x4(
...
std::array<std::array<float, 4>, 4> invertSe3Matrix4x4(
    const std::array<std::array<float, 4>, 4> &matrix);

void printMatrix(std::vector<std::vector<float>> &matrix);

std::vector<std::vector<float>> toVecMatrix4x4(
    const std::array<std::array<float, 4>, 4> &m);
bool isIdentity4x4(const std::vector<std::vector<float>> &m,
                   float epsilon = MATRIX_EQ_EPSILON);
