...
struct adl_serializer<dai::RecordConfig> {
  static void to_json(
      json &j,
      const dai::RecordConfig &p) {  // NOLINT this is a specialization,
  ...
  static void from_json(
      const json &j,
      dai::RecordConfig &p) {  // NOLINT this is a specialization, naming
    ...
    } else if (profile == "h264_main" || profile == "avc_main" ||
               profile == "h264" || profile == "avc") {
      p.videoEncoding.profile = dai::RecordConfig::Profile::H264_MAIN;
    } else if (profile == "h265_main" || profile == "hevc_main" ||
               profile == "h265" || profile == "hevc") {
