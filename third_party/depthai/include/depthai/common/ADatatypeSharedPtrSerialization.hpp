...
struct adl_serializer<std::shared_ptr<dai::ADatatype>> {
  static void to_json(json &j,
                      const std::shared_ptr<dai::ADatatype>
                          & /*opt*/) {  // NOLINT this is a specialization,
                                        // naming conventions don't apply
    j = nullptr;
  }

  static void from_json(const json & /*j*/,
                        std::shared_ptr<dai::ADatatype>
                            &opt) {  // NOLINT this is a specialization, naming
...
namespace nop {
template <>
struct Encoding<std::shared_ptr<dai::ADatatype>>
    : EncodingIO<std::shared_ptr<dai::ADatatype>> {
  ...
  static constexpr std::size_t Size(const Type & /* value */) { return 0; }
