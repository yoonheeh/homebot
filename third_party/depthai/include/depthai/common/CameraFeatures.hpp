...
DEPTHAI_SERIALIZE_EXT(CameraSensorConfig, width, height, minFps, maxFps, fov,
                      type, hdr, hfr);
...
struct CameraFeatures {
  ...
  DEPTHAI_SERIALIZE(CameraFeatures, socket, sensorName, width, height,
                    orientation, supportedTypes, hasAutofocusIC, hasAutofocus,
                    name, additionalNames, configs, calibrationResolution);
};
...
inline std::ostream &operator<<(std::ostream &out,
                                const dai::CameraFeatures &camera) {
...
inline std::ostream &operator<<(
    std::ostream &out, const std::vector<dai::CameraFeatures> &cameras) {
  out << "[";
...
inline std::ostream &operator<<(std::ostream &out,
                                const dai::CameraSensorConfig &config) {
...
inline std::ostream &operator<<(
    std::ostream &out, const std::vector<dai::CameraSensorConfig> &configs) {
  out << "[";
