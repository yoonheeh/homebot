...
class AutoCalibrationResult : public Buffer {
 public:
   ...
   * @param dataConfidence Confidence score of the input data used for
   * calibration.
   ...
   * @param calibration The actual calibration handler containing the new
   * parameters.
   */
  AutoCalibrationResult(double dataConfidence, double calibrationConfidence,
