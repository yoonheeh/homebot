...
class ImgFrame;
using VisualizeType = std::variant<std::shared_ptr<ImgAnnotations>,
                                   std::shared_ptr<ImgFrame>, std::monostate>;
...
class Buffer : public ADatatype {
 public:
   ...
   * Get visualizable message
   @return Visualizable message, either ImgFrame, ImgAnnotations or
   std::monostate (None)
  */
