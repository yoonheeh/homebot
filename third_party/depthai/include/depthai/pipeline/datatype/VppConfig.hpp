...
class VppConfig : public Buffer {
 public:
  ...
  struct InjectionParameters {
     ...
     */
    bool getUseInjection() const { return useInjection; }

    /**
     * @brief Enable or disable injection
     * @param value True to use injection, false to disable
     */
    void setUseInjection(bool value) { useInjection = value; }
     ...
     */
    void setKernelSize(int value) { kernelSize = value; }

    /**
     * @brief Get texture threshold
     * @return Texture threshold value
     */
    float getTextureThreshold() const { return textureThreshold; }

    /**
     * @brief Set texture threshold
     * @param value Texture threshold to set
     */
    void setTextureThreshold(float value) { textureThreshold = value; }
   ...
   */
  float getBlending() const { return blending; }
   ...
   */
  void setBlending(float value) { blending = value; }

  /**
   * @brief Get distance gamma
   * @return Current distance gamma
   */
  float getDistanceGamma() const { return distanceGamma; }

  /**
   * @brief Set distance gamma
   * @param value Distance gamma to set
   */
  void setDistanceGamma(float value) { distanceGamma = value; }

  /**
   * @brief Get maximum patch size
   * @return Maximum patch size
   */
  uint8_t getMaxPatchSize() const { return maxPatchSize; }

  /**
   * @brief Set maximum patch size
   * @param value Patch size to set
   */
  void setMaxPatchSize(uint8_t value) { maxPatchSize = value; }

  /**
   * @brief Get patch coloring type: UNIFORM/MAXDIST
   * @return Current patch coloring type
   */
  PatchColoringType getPatchColoringType() const { return patchColoringType; }
   ...
   */
  bool getUniformPatch() const { return uniformPatch; }

  /**
   * @brief Enable or disable uniform patching
   * @param value True to enable, false to disable
   */
  void setUniformPatch(bool value) { uniformPatch = value; }
   ...
   */
  int getMaxNumThreads() const { return maxNumThreads; }

  /**
   * @brief Set maximum number of threads
   * @param value Number of threads to set
   */
  void setMaxNumThreads(int value) { maxNumThreads = value; }
   ...
   */
  void setMaxFPS(int value) { maxFPS = value; }
  ...
  DEPTHAI_SERIALIZE(VppConfig, blending, distanceGamma, maxPatchSize,
                    patchColoringType, uniformPatch, injectionParameters,
