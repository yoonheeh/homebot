...
class EncodedFrame : public Buffer, public ProtoSerializable {
 public:
  ...
  DEPTHAI_SERIALIZE(EncodedFrame, cam, instanceNum, width, height, quality,
                    bitrate, profile, lossless, type, frameOffset, frameSize,
                    transformation, Buffer::sequenceNum, Buffer::ts,
                    Buffer::tsDevice);
};
