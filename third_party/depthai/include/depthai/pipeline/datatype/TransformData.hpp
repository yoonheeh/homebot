...
class TransformData : public Buffer {
 public:
  ...
  TransformData(double x, double y, double z, double qx, double qy, double qz,
                double qw);
  TransformData(double x, double y, double z, double roll, double pitch,
                double yaw);
  ...
  DEPTHAI_SERIALIZE(TransformData, Buffer::sequenceNum, Buffer::ts,
                    Buffer::tsDevice, transform);
};
