...
/**
 * ObjectTrackerConfig message. Carries ROI (region of interest) and threshold
...
class ObjectTrackerConfig : public Buffer {
 public:
  ...
  DEPTHAI_SERIALIZE(ObjectTrackerConfig, Buffer::sequenceNum, Buffer::ts,
                    Buffer::tsDevice, trackletIdsToRemove);
};
