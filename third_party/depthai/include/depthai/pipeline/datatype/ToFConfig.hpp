...
class ToFConfig : public Buffer {
 public:
  ...
  filters::params::MedianFilter median =
      filters::params::MedianFilter::MEDIAN_OFF;
  ...
  /*
   * Enable distortion correction for intensity, amplitude and depth output, if
  ...
  DEPTHAI_SERIALIZE(ToFConfig, median, enablePhaseShuffleTemporalFilter,
                    enableBurstMode, enableDistortionCorrection,
                    enableFPPNCorrection, enableOpticalCorrection,
                    enableTemperatureCorrection, enableWiggleCorrection,
                    enablePhaseUnwrapping, phaseUnwrappingLevel,
