...
typedef std::variant<MedianFilterParams, SpatialFilterParams,
                     SpeckleFilterParams, TemporalFilterParams>
    FilterParams;
...
class ImageFiltersConfig : public Buffer {
 public:
   ...
   */
  ImageFiltersConfig &updateFilterAtIndex(std::int32_t index,
                                          FilterParams params);
