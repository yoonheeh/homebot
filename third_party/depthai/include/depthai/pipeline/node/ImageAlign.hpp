...
/**
 * @brief ImageAlign node. Calculates spatial location data on a set of ROIs on
 * depth map.
 */
class ImageAlign
    : public DeviceNodeCRTP<DeviceNode, ImageAlign, ImageAlignProperties>,
      public HostRunnable {
 public:
 ...
 public:
  ...
  std::shared_ptr<ImageAlignConfig> initialConfig =
      std::make_shared<ImageAlignConfig>();
  ...
  Input inputConfig{*this,
                    {"inputConfig",
                     ...
                     false,
                     4,
                     {{DatatypeEnum::ImageAlignConfig, false}}}};
  ...
  Input input{
      *this,
      {"input", DEFAULT_GROUP, false, 4, {{DatatypeEnum::ImgFrame, false}}}};
  ...
  Output outputAligned{
      *this,
      {"outputAligned", DEFAULT_GROUP, {{DatatypeEnum::ImgFrame, false}}}};
  ...
  Output passthroughInput{
      *this,
      {"passthroughInput", DEFAULT_GROUP, {{DatatypeEnum::ImgFrame, false}}}};
