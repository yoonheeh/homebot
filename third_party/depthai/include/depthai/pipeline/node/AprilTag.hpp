 ...
 */
class AprilTag
    : public DeviceNodeCRTP<DeviceNode, AprilTag, AprilTagProperties>,
      public HostRunnable {
 private:
 ...
 public:
  ...
  std::shared_ptr<AprilTagConfig> initialConfig =
      std::make_shared<AprilTagConfig>();
  ...
  Input inputConfig{*this,
                    {"inputConfig",
                     ...
                     false,
                     4,
                     {{{DatatypeEnum::AprilTagConfig, false}}},
   ...
   */
  Output out{*this,
             {"out", DEFAULT_GROUP, {{{DatatypeEnum::AprilTags, false}}}}};
  ...
  Output outConfig{
      *this,
      {"outConfig", DEFAULT_GROUP, {{{DatatypeEnum::AprilTagConfig, false}}}}};
  ...
  /**
   * Specify whether or not wait until configuration message arrives to
   * inputConfig Input.
  ...
  /**
   * @brief Get whether or not wait until configuration message arrives to
   * inputConfig Input.
   */
