 ...
 */
class EdgeDetector
    : public DeviceNodeCRTP<DeviceNode, EdgeDetector, EdgeDetectorProperties> {
 public:
 ...
 public:
  ...
  std::shared_ptr<EdgeDetectorConfig> initialConfig =
      std::make_shared<EdgeDetectorConfig>();

  /**
   * Input EdgeDetectorConfig message with ability to modify parameters in
  ...
  Input inputConfig{*this,
                    {"inputConfig",
                     ...
                     false,
                     4,
                     {{{DatatypeEnum::EdgeDetectorConfig, false}}},
  ...
  Output outputImage{
      *this,
      {"outputImage", DEFAULT_GROUP, {{{DatatypeEnum::ImgFrame, false}}}}};
