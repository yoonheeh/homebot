...
struct VideoEncoderProperties
    : PropertiesSerializable<Properties, VideoEncoderProperties> {
  /**
   * Rate control mode specifies if constant or variable bitrate should be used
   * (H264 / H265)
   */
  ...
  /**
   * Specifies preferred bitrate (in bit/s) of compressed output bitstream in
   * CBR mode
   *
  ...
  /**
   * Specifies maximum bitrate (in bit/s) of compressed output bitstream in CBR
   * mode
   *
...
DEPTHAI_SERIALIZE_EXT(VideoEncoderProperties, bitrate, keyframeFrequency,
                      maxBitrate, numBFrames, numFramesPool, outputFrameSize,
                      profile, quality, lossless, rateCtrlMode, frameRate);
