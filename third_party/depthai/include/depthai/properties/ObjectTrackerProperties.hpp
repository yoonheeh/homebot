...
struct ObjectTrackerProperties
    : PropertiesSerializable<Properties, ObjectTrackerProperties> {
  /**
...
DEPTHAI_SERIALIZE_EXT(ObjectTrackerProperties, trackerThreshold,
                      maxObjectsToTrack, detectionLabelsToTrack, trackerType,
                      trackerIdAssignmentPolicy, trackingPerClass,
                      occlusionRatioThreshold, trackletMaxLifespan,
                      trackletBirthThreshold, spatialAssociation,
                      spatialAssociationWeight, spatialDistanceThreshold,
