...
struct ImageAlignProperties
    : PropertiesSerializable<Properties, ImageAlignProperties> {
...
DEPTHAI_SERIALIZE_EXT(ImageAlignProperties, initialConfig, numFramesPool,
                      alignWidth, alignHeight, warpHwIds, interpolation,
