...
streamId_t XLinkAddOrUpdateStream(void *fd, const char *name,
                                  uint32_t writeSize, uint32_t readSize,
                                  streamId_t forcedId);
...
#define XLINK_INIT_EVENT(event, in_streamId, in_type, in_size, in_data, \
                         in_deviceHandle)                               \
  do {                                                                  \
