 ...
 public:
  ...
  template <
      ...
      std::enable_if_t<
          std::conjunction<
              std::negation<std::is_same<xoptional<CT, CB>, std::decay_t<T>>>,
              std::is_constructible<CT, T &&>,
              std::negation<std::is_convertible<T &&, CT>>>::value,
          bool> = false>
  ...
  template <
      ...
      std::enable_if_t<
          std::conjunction<
              std::negation<
                  std::is_same<xoptional<CT, CB>, xoptional<CTO, CBO>>>,
                ...
                std::conjunction<
                    ...
                    std::conjunction<
                        ...
                        std::is_convertible<
                            ...
                            CB>>,
                    std::negation<
                        detail::converts_from_xoptional<CT, CTO, CBO>>>::value,
                bool> = true>
  ...
  std::enable_if_t<
      std::conjunction<
          ...
          std::negation<detail::converts_from_xoptional<CT, CTO, CBO>>,
          std::negation<detail::assigns_from_xoptional<CT, CTO, CBO>>>::value,
      xoptional &> inline
...
#define TERNARY_OPTIONAL_12(NAME)                                             \
  ...
  inline auto NAME(const xoptional<T1, B1> &e1, const xoptional<T2, B2> &e2,  \
                   const T3 &e3) -> common_optional_t<T1, T2, T3> {           \
    using std::NAME;                                                          \
    using value_type = std::common_type_t<std::decay_t<T1>, std::decay_t<T2>, \
                                          std::decay_t<T3>>;                  \
