...
using is_gen_complex =
    std::disjunction<is_complex<std::decay_t<T>>, is_xcomplex<std::decay_t<T>>>;
...
class xcomplex {
 public:
  ...
  template <class OCTR,
            std::enable_if_t<
                std::conjunction<std::negation<is_gen_complex<OCTR>>,
  ...
  template <class OCTR,
            std::enable_if_t<
                std::conjunction<
                    ...
                    std::is_constructible<CTR, OCTR &&>,
                    std::negation<std::is_convertible<OCTR &&, CTR>>>::value,
                bool> = true>
...
constexpr detail::forward_type_t<T, M> forward_offset(T &&v) noexcept {
  ...
  return static_cast<forward_type>(*reinterpret_cast<cv_value_type *>(
